...
import theHustler.patches.relics.BottledPlaceholderField;
import theHustler.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theHustler.DefaultMod.makeRelicOutlinePath;
import static theHustler.DefaultMod.makeRelicPath;
